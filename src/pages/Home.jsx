...
function Home() {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-600 py-12 sm:py-16 lg:py-20 xl:py-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                <Link to="/products">
                  <button className="bg-white text-indigo-600 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold text-base sm:text-lg hover:bg-blue-100 transition-all duration-300 transform hover:scale-105 shadow-lg touch-target">
                    Shop Now
                  </button>
                </Link>
                <Link to="/categories">
                  <button className="border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold text-base sm:text-lg hover:bg-white hover:text-indigo-600 transition-all duration-300 touch-target">
                    Browse Categories
                  </button>
                </Link>
              </div>
            ...
            <div className="hidden lg:block">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-full blur-3xl opacity-30"></div>
          ...
          <div className="mx-auto max-w-7xl container-padding-mobile">
            <div className="text-center mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4 flex items-center justify-center">
                <FaStar className="text-blue-500 mr-2 sm:mr-3 text-2xl sm:text-3xl" />
                Top Rated Products
              </h2>
              <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
                    ...
                    <div className="relative">
                      ...
                      {slide.mainBadgeName && (
                        <div 
                          ...
                          style={{ backgroundColor: slide.mainBadgeColor || '#6366f1' }}
                        >
                          {slide.mainBadgeName}
                        </div>
                      )}
      ...
      <section className="py-12 sm:py-16 bg-gradient-to-r from-blue-400 to-indigo-500">
        <div className="mx-auto max-w-7xl container-padding-mobile">
          <div className="text-center mb-8 sm:mb-12">
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="mx-auto max-w-7xl container-padding-mobile">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center p-4 sm:p-6 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 hover-lift">
